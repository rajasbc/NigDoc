...
class Edit_doctor extends StatefulWidget {
  final select_doctor;
  const Edit_doctor({super.key,request, this.select_doctor});

  @override
  
  State<Edit_doctor> createState() => _Edit_doctor();
}

class _Edit_doctor extends State<Edit_doctor> {
...
getdepartment();
 ...
 return  PopScope(
    ...
    child: Scaffold(
      appBar: AppBar(title: Text('Edit Doctor',style: TextStyle(color: Colors.white),),
