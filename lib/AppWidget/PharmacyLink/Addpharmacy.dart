...
class AddPharmancylist extends StatefulWidget {
  const AddPharmancylist({super.key});

  @override
  State<AddPharmancylist> createState() => _AddpharmancylistState();
}

class _AddpharmancylistState extends State<AddPharmancylist> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
        ...
        onPopInvoked: (bool didPop) {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => PharmacyList()));
        },
        child: Scaffold(
          appBar: AppBar(
            title: Text(
                              ...
                              child: TextField(
                                ...
                                onChanged: (text) async {
                                  ...
                                  var List = await PatientApi()
                                      .searchpharmacy(accesstoken, data);
                                  print(List);
                                  labList = List['list'];
                                  print(labList);
                                ...
                                decoration: new InputDecoration(
                                  ...
                                  hintText: 'Search Pharmacy Name or Number',
                                ),
                              ),
                            ),
              ...
              actions: [
                ...
                SizedBox(
                  height: screenHeight * 0.04,
                                      ...
                                      title: SizedBox(child: Text('Pharmacy Name : ${data['username']}',style: TextStyle(fontWeight: FontWeight.bold))),
                                      ...
                                      subtitle: Column(
                                        children: [
                                          Container(
                                            ...
                                            child: Text('Mobile: ${data['contact_no']}',style: TextStyle(fontWeight: FontWeight.bold),)),
                                            SizedBox(height: screenHeight*0.01,),
                                          Container(
                                             width: screenWidth*0.77,
                                            child: Text('Email : ${data['email']}',style: TextStyle(fontWeight: FontWeight.bold))),
                                            SizedBox(height: screenHeight*0.01,),
                                          // Container(
                                          //    width: screenWidth*0.77,
