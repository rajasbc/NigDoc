...
class _department_ListState extends State<department_List> {
  ...
  final FocusNode adddepartmentFocusNode = FocusNode();
  ...
  List test_List = [];
  void dispose() {
    adddepartmentFocusNode.dispose();
  }

  @override
  Widget build(BuildContext context) {
    Map<String, String> data = {'department_name': ''};
                                                                                    ...
                                                                                    child: ElevatedButton(
                                                                                      ...
                                                                                      onPressed: (() async {
                                                                                        if (departmentcontroller.text.isEmpty) {
                                                                                          ...
                                                                                          var list = await PatientApi().Editdepartment(accesstoken, value);
                ...
                builder: ((context) => AlertDialog(
                      actions: [
                        ...
                        TextFormField(
                          ...
                          focusNode: adddepartmentFocusNode,
                          decoration: InputDecoration(
                            border: OutlineInputBorder(),
                            labelText: 'Department *',
                          ),
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: (() async {
                                  if (adddepartmentcontroller.text.isEmpty) {
                                    adddepartmentFocusNode.requestFocus();
                                    NigDocToast()
                                        .showErrorToast('Enter Department');
                                  } else {
                                    var data = {
                                      "department_name": adddepartmentcontroller
                                          .text
                                          .toString(),
                                    };
                                    var list = await PatientApi()
