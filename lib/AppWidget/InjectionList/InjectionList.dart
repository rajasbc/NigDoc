                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Helper().isvalidElement(Injection_List) &&
                                                                      ...
                                                                      data2 = {
                                                                        injectionnamecontroller
                                                                            .text = data[
                                                                                'injections_name']
                                                                            .toString(),
                                                                        injectionamountcontroller
                                                                            .text = data[
                                                                                'injection_amount']
                                                                            .toString(),
                                                                        injectionqtycontroller
                                                                            .text = data[
                                                                                'injection_qty']
                                                                            .toString(),
                                                                        expdatecontroller
                                                                                      ...
                                                                                      ElevatedButton(
                                                                                          ...
                                                                                          onPressed: () async {
                                                                                            ...
                                                                                            expdateFocusNode.requestFocus();
                                                                                              ...
                                                                                              var list = await PatientApi().Editinjection(accesstoken, items);
                                                                      ...
                                                                      showDialog(
                                                                          ...
                                                                          builder: (context) =>
                                                                              AlertDialog(actions: [
                                                                                ...
                                                                                Container(
                                                                                  child: Text(
                                                                                    'Are you sure you want to delete the Medicine Details?',
                                                                                      ...
                                                                                      Container(
                                                                                        child: ElevatedButton(
                                                                                            ...
                                                                                            onPressed: () async {
                                                                                              ...
                                                                                              var list = await PatientApi().Deleteinjection(accesstoken, value);
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => Add_injection()));
            },
            child: Icon(
              Icons.add,
              size: 30,
