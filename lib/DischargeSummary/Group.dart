...
class _grouplistState extends State<grouplist> {
  ...
  Widget build(BuildContext context) {
    groupList2=Helper().isvalidElement(searchList)&&searchText.text.isNotEmpty?searchList: groupList;
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Group List',style: TextStyle(color: Colors.white),),
            ...
            child: SingleChildScrollView(
              child: Container(
                          ...
                          onChanged: (text) {
                            ...
                            // var list = ProductListItem;
                              searchList = groupList.where((element) {
                                var groupList1 = element['group_name'].toString().toLowerCase();
                ...
                SizedBox(height: screenHeight*0.02,),
                    Helper().isvalidElement(groupList2) && groupList2.length > 0 ?  
                  Container(
                      height: screenHeight*0.80,
                       child: Padding(
                         ...
                         child: ListView.builder(
                                             ...
                                             PopupMenuButton(itemBuilder: (context)=>[
                                              PopupMenuItem(child: Row(
                                                     ...
                                                     onTap: (){
                                                       ...
                                                       Navigator.push(context, MaterialPageRoute(builder: (context)=>viewgroup(select_group :data)));
                                                     },
                                               ...
                                               PopupMenuItem(child: Row(
                                                     ...
                                                     onTap: (){
                                                       var item = {
                                                  editgroupnamecontroller.text = data['group_name']
                                                };
                          ...
                          SizedBox(height: screenHeight*0.04,),
                            ...
                            actions: [
                              ...
                              SizedBox(height: screenHeight*0.02,),
                               Center(child: Container(child: Text('DELETE GROUP ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),))),
                               SizedBox(height: screenHeight*0.02,),
                               Container(
                                child: Text('Are you sure you want to delete the Group  Details?',style: TextStyle(fontSize: 16),),
                               ),
                                SizedBox(height: screenHeight*0.02,),
                               Container(
                                child: Row(
