              ...
              child: Container(
                ...
                child: Column(
                  children: [
                                                            ...
                                                            NigDocToast().showErrorToast('Enter your Rate');
                                                                         ...
                                                                         var items={
                                                                          'category_id':data1['id'].toString(),
                                                                           "subcategory_name":namecontroller.text.toString(),
                      ...
                      //  listview(items),
                      Helper().isvalidElement(Subcategory_List) && Subcategory_List.length > 0 ?  
                    Container(
                      // color: Colors.amber,
                                             ...
                                             children: [
                                               PopupMenuButton(itemBuilder: (context)=>[
                                                ...
                                                PopupMenuItem(child: Row(
                                                       ...
                                                       onTap: ()async {
                                                                var item1 = {
                                                    editnamecontroller.text = data['subcategory_name'],
                                                    editratecontroller.text = data['rate']
                                                  };
                                  ...
                                  child: Center(
                                    child: ElevatedButton(
                                      ...
                                      onPressed: ()async{
                                               ...
                                               var list = await PatientApi()
                                        .editSubcategory( accesstoken, value);
                                    if (list['message'] ==
                                      ...
                                      NigDocToast()
                                          .showErrorToast('Please TryAgain later');
                                                 ...
                                                 var list = await PatientApi()
                                          .deleteSubcategory( accesstoken, value);
                                      if (list['message'] ==
