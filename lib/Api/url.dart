...
String getDocTreatmentBillList= 'auth/getdoctreatmentbilllist';
String getTreatmentPayList= 'auth/gettreatmentpaylist';
String getDocTreatmentChargeList= 'auth/getdoctreatmentchargelist';
String DocTreatmentPay= 'auth/doctreatmentpay';
String getDocInPatientDetails= 'auth/getdocinpatientdetails';
String getInPatientPayList= 'auth/getinpatientpaylist';
String DocInpatientPay= 'auth/docinpatientpay';
String getDocFloor= 'auth/getdocfloor';
String DocAddFloor= 'auth/docaddfloor';
String DocEditFloor= 'auth/doceditfloor';
String DocDeleteFloor= 'auth/docdeletefloor';
String getDocWardList= 'auth/getdocwardlist';
String DocAddWard= 'auth/docaddward';
String DocEditWard= 'auth/doceditward';
String DocDeleteWard= 'auth/docdeleteward';
String getWardListRoom= 'auth/getwardlistroom';
String getRoomList= 'auth/getroomlist';
String AddDocRoom= 'auth/adddocroom';
String getEditRoomList= 'auth/geteditroomlist';
String DocEditRoom= 'auth/doceditroom';
String DocDeleteRoom= 'auth/docdeleteroom';
String getBedCategoryList= 'auth/getbedcategorylist';
String DocDeleteBedCategory= 'auth/docdeletebedcategory';
String getBedCategoryRoomList= 'auth/getbedcategoryroomlist';
String AddBedCategory= 'auth/addbedcategory';
...
String getWorkingHoursViewList= 'auth/getworkinghoursviewlist';
String getDoctorScheduleList= 'auth/getdoctorschedulelist';
