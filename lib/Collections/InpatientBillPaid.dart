...
class inpatientpaid extends StatefulWidget {
  const inpatientpaid({super.key});

  @override
  State<inpatientpaid> createState() => _inpatientpaidState();
}

class _inpatientpaidState extends State<inpatientpaid> {
