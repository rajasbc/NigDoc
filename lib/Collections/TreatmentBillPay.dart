...
class TreatmentBillPay extends StatefulWidget {
  const TreatmentBillPay({super.key});

  @override
  State<TreatmentBillPay> createState() => _TreatmentBillPayState();
}

class _TreatmentBillPayState extends State<TreatmentBillPay> {
  ...
  TreatmentPay_bill() async {
    if (receivedController.text.isEmpty) {
      ...
      var data = {
        ...
        'treat_id': treat_id.toString(),
        "patient_id":id.toString(),
        "discharge_id":discharge_id.toString(),
        'after_discount': bill_amount.toString(),
      ...
      print(data);
      var getvalue = await billingapi().DocTreatmentPay(access_token, data);
      print(getvalue);
